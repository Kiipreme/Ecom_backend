    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deliveredAt', models.DateTimeField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shippingPrice', models.DecimalField(blank=True, decimal_places=2, max_digits=7)),
                ('order', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, to='eCom.order')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
